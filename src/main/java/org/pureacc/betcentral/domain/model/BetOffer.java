...
public class BetOffer {
    ...
    public DecimalOdds getNoVigOddsA() {
        Percentage noVigProbabilityA = oddsA.getProbability().divide(getOverallPercentMarket());
        return noVigProbabilityA.getDecimalOdds();
    }

    public DecimalOdds getNoVigOddsB() {
        Percentage noVigProbabilityB = oddsB.getProbability().divide(getOverallPercentMarket());
        return noVigProbabilityB.getDecimalOdds();
    }

    private Percentage getOverallPercentMarket() {
        return Percentage.of(100).add(vig.getPercentage());
    }
}
