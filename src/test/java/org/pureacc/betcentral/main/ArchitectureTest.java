...
public class ArchitectureTest {
    ...
    public void properPackageStructure() {
        classes().should().resideInAnyPackage(MAIN, VOCABULARY, DOMAIN, APPLICATION_API, APPLICATION_COMMAND, APPLICATION_QUERY)
                .orShould().resideInAnyPackage(CALLING_INFRA)
                .orShould().resideInAnyPackage(IMPLEMENTING_INFRA)
                .check(classes);
    }
    ...
    public void vocabulary() {
        classes()
                .that().resideInAPackage(VOCABULARY)
                .should().onlyAccessClassesThat().resideInAnyPackage(VOCABULARY, WHITELIST)
                .check(classes);
    }
    ...
    public void domain() {
        classes()
                ...
                .should().onlyAccessClassesThat().resideInAnyPackage(DOMAIN, VOCABULARY, WHITELIST)
                .check(classes);
    }
    ...
    public void applicationApi() {
        classes()
                .that().resideInAPackage(APPLICATION_API)
                .should().onlyAccessClassesThat().resideInAnyPackage(APPLICATION_API, VOCABULARY, WHITELIST)
                .check(classes);
    }
    ...
    public void applicationCommand() {
        classes()
                .that().resideInAPackage(APPLICATION_COMMAND)
                .should().onlyAccessClassesThat().resideInAnyPackage(APPLICATION_COMMAND, APPLICATION_API, DOMAIN, VOCABULARY, WHITELIST)
                .check(classes);
    }
    ...
    public void applicationQuery() {
        classes()
                .that().resideInAPackage(APPLICATION_QUERY)
                .should().onlyAccessClassesThat().resideInAnyPackage(APPLICATION_QUERY, APPLICATION_API, DOMAIN, VOCABULARY, WHITELIST)
                .check(classes);
    }
    ...
    public void callingInfra() {
        classes()
                .that().resideInAnyPackage(CALLING_INFRA)
                .should().onlyAccessClassesThat().resideOutsideOfPackages(APPLICATION_QUERY, APPLICATION_COMMAND, DOMAIN)
                .check(classes);
    }
    ...
    public void implementingInfra() {
        classes()
                .that().resideInAnyPackage(IMPLEMENTING_INFRA)
                .should().onlyAccessClassesThat().resideOutsideOfPackages(APPLICATION_QUERY, APPLICATION_COMMAND)
                .check(classes);
    }
}
